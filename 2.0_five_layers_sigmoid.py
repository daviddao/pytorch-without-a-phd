...
def build_model(input_dim, output_dim):
    ...
    model.add_module("sigmoid3", torch.nn.Sigmoid())        
    model.add_module("linear4", torch.nn.Linear(60, 30, bias=True))
    model.add_module("sigmoid4", torch.nn.Sigmoid())        
...
datavis.animate(training_step, iterations=10000, train_data_update_freq=50, test_data_update_freq=50, more_tests_at_start=True)
